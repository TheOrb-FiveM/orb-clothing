-- GTA V tattoo overlay data (Rockstar game identifiers), grouped by body zone.
-- Zone keys: ZONE_TORSO, ZONE_LEFT_ARM, ZONE_HEAD, ZONE_LEFT_LEG, ZONE_RIGHT_LEG
-- Each entry: { name, label, hashMale, hashFemale, zone, collection }
